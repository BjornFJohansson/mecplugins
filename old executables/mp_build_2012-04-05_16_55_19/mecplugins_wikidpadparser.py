...
WIKI_LANGUAGE_NAME = "wikidpad_ext_2_0"
WIKI_HR_LANGUAGE_NAME = u"WikidPad ext 2.0"
...
+ur"\d+(\-\d+)+|"
+ur"[" + LETTERS + ur"]+((\-|\d+)(\w+|\d)?)+|"
+ur"[" + UPPERCASE + ur"]+[" + LOWERCASE + ur"]+[" + UPPERCASE + ur"]+[" + LETTERS + string.digits + ur"]*|"
+ur"[" + LOWERCASE + ur"]+[" + UPPERCASE + ur"]+[" + LETTERS + string.digits + ur"\-" + ur"]*|"
+ur"[" + UPPERCASE + ur"]{2,30}"
+ur")")
...
#                                 match.group(2), int(prevNum)+1))
    ...
    def handleRewrapText(editor, settings):
        ...
        if (startLine <= endLine):
            ...
            # editor.GotoPos(curPos)   # changed here !
            editor.GotoPos(endPos-1)     # changed here !
