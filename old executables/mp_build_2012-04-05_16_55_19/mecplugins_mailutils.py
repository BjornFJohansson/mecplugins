...
def sendbymail(wiki, evt):
    ...
    subject         = content.splitlines()[0] # The first line of the content is the subject
    smtptimeout     = 30
    ...
    recipients_from_settings_page = wiki.getWikiDocument().getWikiPage("WikiSettings/mecplugins/mail-contacts").getContent().splitlines()
    ...
    themsg['Bcc']          = bcc_recipients
    themsg['Subject']      = subject
    themsg.preamble = 'I am not using a MIME-aware mail reader.\n'
    themsg.attach(MIMEText(content))

    if bcc_recipients and not bcc_recipients.isspace():
        recipients.append(bcc_recipients.encode())
