...
def describeMenuItems(wiki):
    return (	(dewrap, 		    _(u"MECplugins|Text utils|Dewrap selected text")	                , _(u"dewrap selection")),
                ...
                (underline, 		_(u"MECplugins|Text utils|underline selected text\tShift-Ctrl-U")	, _(u"underline")),
...
def underline(wiki, evt):
    ...
    wiki.getActiveEditor().AddText(underline)
    wiki.getActiveEditor().SetSelection(start, end+len(underline))
    return
